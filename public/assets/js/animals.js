...
const getAnimals = (formData = {}) => {
   ...
   // The Object.entries() method returns an array of enumerable string-keyed property [key, value] pairs
   // of a given (formData) object.
   // Loop through returned array to process each [key, value] pair. in this particular case, the process consists
   // in building HTML query parameters. i.e. ?diet=carnivore&personalityTrait=goofy&... etc.
